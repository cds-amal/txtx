...
fn generate_action_hover_text(spec: &txtx_addon_kit::types::commands::CommandSpecification) -> String {
    let mut content = String::new();
...
mod tests {
    ...
    fn test_specific_function_hover_content() {
        ...
        assert!(evm_contract_hover.is_some(), "Should have hover for evm::get_contract_from_foundry_project");
