...
"#;
        ...
        assert!(first_diag.message.contains("parse error") || 
                first_diag.message.contains("HCL"));
...
"#;
        ...
        assert!(diagnostics.is_empty() || diagnostics.iter().all(|d| d.severity != Some(lsp_types::DiagnosticSeverity::ERROR)), 
